  ...
  return (
    <div className="pillars-section">
      <div className="pillar">
        <img src="/assets/image/news.jpg" alt="Noticias y Actualidad" className="pillar-icon"/>
        <h2>Noticias y Actualidad</h2>
        <p>Mantente informado con las últimas noticias y actualizaciones del mundo del trading.</p>
      </div>
      <div className="pillar">
        <img src="/assets/image/trading-1.jpg" alt="Simulación de Portfolio" className="pillar-icon"/>
        <h2>Simulación de Portfolio</h2>
        <p>Simula y analiza tus inversiones con nuestra herramienta avanzada de portfolio.</p>
      </div>
      <div className="pillar">
        <img src="/assets/image/trading-2.jpg" alt="Representantes Oficiales" className="pillar-icon"/>
